...
const createOrder = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: 'Order created successfully with selected products',             orderId: newOrder.id, // Order ID
order: newOrder });
...
module.exports = { createOrder, getUserOrders, getOrderDetailsById };
